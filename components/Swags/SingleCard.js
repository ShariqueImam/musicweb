...
const style = {
  wrapper:
    "z-30 w-[75vw] md:w-[22vw] h-[45vh] md:h-[55vh] rounded-xl z-30 mx-2 md:mx-3 my-16  flex flex-col items-center justify-end hover:scale-[0.95] transition duration-[300ms]",
